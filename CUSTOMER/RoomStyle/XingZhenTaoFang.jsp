...
<html class="no-js"> 
	...
	<div id="fh5co-wrap">
		...
		<!-- 行政套房第一画 -->
		<div class="fh5co-hero" style="background-image: url(images/XingZhenTaoFang1.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell">
							<h1 class="text-center"> &nbsp&nbsp行  &nbsp&nbsp政  &nbsp&nbsp套  &nbsp&nbsp房  </h1>
			...
			<div class="container">
				...
				<!-- 第一图 -->
					<div class="col-md-3 fh5co-staff">
						<img src="images/XingZhenTaoFang2.png" class="img-responsive" >
						<h3>行政套房</h3>
						<h4>价格：￥806</h4>
